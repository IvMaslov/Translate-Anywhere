...
function showMeaning (event){
        ...
        sendMessage(info)
            .then((response) => {
                if (!response) { return noMeaningFound(createdDiv); }
...
function sendMessage(text) {
    return browser.runtime.sendMessage(text);
}
...
function createDiv(info) {
    ...
    style.textContent = ".mwe-popups{background:#3FC4CD;position:absolute;z-index:110;-webkit-box-shadow:0 30px 90px -20px rgba(0,0,0,0.3),0 0 1px #a2a9b1;box-shadow:0 30px 90px -20px rgba(0,0,0,0.3),0 0 1px #a2a9b1;padding:0;font-size:16px;min-width:200px;border-radius:2px}.mwe-popups.mwe-popups-is-not-tall{width:20px}.mwe-popups .mwe-popups-container{color:#e5e5e5s;margin-top:-9px;padding-top:9px;text-decoration:none;text-shadow: 0 0 1px black;}.mwe-popups.mwe-popups-is-not-tall .mwe-popups-extract{min-height:40px;max-height:140px;overflow:hidden;margin-bottom:47px;padding-bottom:0}.mwe-popups .mwe-popups-extract{margin:16px;display:block;color:#e5e5e5s;text-decoration:none;position:relative} .mwe-popups.flipped_y:before{content:'';position:absolute;border:8px solid transparent;border-bottom:0;border-top: 8px solid #a2a9b1;bottom:-8px;left:10px}.mwe-popups.flipped_y:after{content:'';position:absolute;border:11px solid transparent;border-bottom:0;border-top:11px solid #3FC4CD;bottom:-7px;left:7px} .mwe-popups.mwe-popups-no-image-tri:before{content:'';position:absolute;border:8px solid transparent;border-top:0;border-bottom: 8px solid #a2a9b1;top:-8px;left:10px}.mwe-popups.mwe-popups-no-image-tri:after{content:'';position:absolute;border:11px solid transparent;border-top:0;border-bottom:11px solid #3FC4CD;top:-7px;left:7px} .audio{background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAcUlEQVQ4y2P4//8/AyUYQhAH3gNxA7IAIQPmo/H3g/QA8XkgFiBkwHyoYnRQABVfj88AmGZcTuuHyjlgMwBZM7IE3NlQGhQe65EN+I8Dw8MLGgYoFpFqADK/YUAMwOsFigORatFIlYRElaRMWmaiBAMAp0n+3U0kqkAAAAAASUVORK5CYII=);background-position: center;background-repeat: no-repeat;cursor:pointer;margin-left: 8px;opacity: 0.5; width: 16px; display: inline-block;} .audio:hover {opacity: 1;}";
...
function appendToDiv(createdDiv, content){
    ...
    createdDiv.heading.textContent = content.text;
    createdDiv.meaning.textContent = content.translated_text;
...
(function () {
    ...
    storageItem.then((results) => {
        SOURCE_LANGUAGE = results.source_language || DEFAULT_SOURCE_LANGUAGE;
        TARGET_LANGUAGE = results.target_language || DEFAULT_TARGET_LANGUAGE;
    });
})();